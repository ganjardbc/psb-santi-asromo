...
// $common = new common();
$gelombang = ang_rom($data->gelombang);
...
<body style="font-family: Arial, \'Helvetica Neue\', Helvetica, sans-serif">
    ...
    border-width: 1px;">
        ...
        <tr>
            <td style="width:25%">
                <img height="35" src="../img/logo2.png">
            </td>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td style="text-align:right;width:60px"><img src="../img/upload/'.$data->pas_foto.'" height="70" width="55"></td>
        </tr>
    </table>
    <hr style="background-color: black; height: 0.25px; border: 0;">
    ...
    <table class="table" style="font-size:7px;width:100%">
        <tr>
            ...
            <td style="text-align:center;"><p>Panitia PSB Pondok Mufidah Santi Asromo</p><img src="../img/asromologo.png" height="35"></td>
        </tr>
    </table>
    </div>
